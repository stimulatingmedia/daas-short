/* Scene 4 — Don't settle for "good enough" (21–27s). Galaxy White.
...
const CARD = { x: 110, y: 880, w: 860, pad: 38, padTop: 36 };     // frame px
...
export default function SceneSettle() {
  ...
  return (
    <Scene start={start} end={end} bg={<Fill color={C.white} />}>
      ...
      {/* The aside: a short dashed connector draws down to the potential peak, then the green marker wipes in. */}
      <Connector at={B.marker} d={`M 872 842 C 900 870, ${PEAK.x - 6} ${PEAK.y - 60}, ${PEAK.x - 2} ${PEAK.y - 22}`} color={C.navy} arrow />
      <Marker at={B.marker + T.fill * 0.6} x={690} y={776} text="your potential" size={50} color={C.green} rot={-6} align="left" />
